...
# Public URL prefix when the app sits behind a proxy (Next rewrite, Vercel routePrefix,
# etc.). The proxy forwards /svc/api/<path> to this app as /<path>; root_path makes
# Swagger/OpenAPI use /svc/api/openapi.json in the browser instead of /openapi.json.
_root_path = (os.getenv("ROOT_PATH") or "").strip().rstrip("/")
